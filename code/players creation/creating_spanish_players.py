...
first_name_query = "SELECT first_names.value FROM first_names INNER JOIN regions ON id_region = id_region WHERE regions.language='Spanish';"
last_name_query = "SELECT last_names.value FROM last_names INNER JOIN regions ON id_region = id_region WHERE regions.language='Spanish';"
