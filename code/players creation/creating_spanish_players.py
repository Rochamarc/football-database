...
first_name_query = "SELECT first_names.value FROM first_names INNER JOIN regions ON first_names.id_region = regions.id WHERE regions.language='Spanish';"
last_name_query = "SELECT last_names.value FROM last_names INNER JOIN regions ON last_names.id_region = regions.id WHERE regions.language='Spanish';"
